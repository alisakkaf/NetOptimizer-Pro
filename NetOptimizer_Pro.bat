...
chcp 65001 >nul
title NetOptimizer Pro v2.7 - By ALI SAKKAF
...
echo %C_WHT%   ║%C_GRN%                    Developed By: A L I  S A K K A F  v2.7               %C_WHT%║%C_RST%
...
echo %C_GRY%[%time:~0,8%]%C_RST% %C_YEL%[BACKUP]%C_RST% Creating System Restore Point...
...
echo %C_GRY%[%time:~0,8%]%C_RST% %C_GRN%[DONE]%C_RST% System Restore Point Created (Skipped if failed).
