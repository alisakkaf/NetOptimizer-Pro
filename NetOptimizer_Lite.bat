...
chcp 65001 >nul
title NetOptimizer Lite v3.2 - By ALI SAKKAF
...
echo.
echo ==============================================================================
echo                      ULTIMATE NETWORK ^& UPDATE KILLER (LITE) v3.2
...
echo [INFO] Disabling Delivery Optimization P2P ^& Background AI Queries...
